...
const deployContract = async() => {
    ...
    let sdk = await initializeSDK(this, { account, wallet }, true)
...
describe("Test cases for Allowances Page", () => {
    ...
    it("open create allowance page, validate all fields and create allowance", () => {
        ...
        .should('be.visible')
        .get('h1')
        .should('contain', 'Incorrect fields')
        .should('be.visible')
        .get('.buttons > .ae-button')
        .click()
        .get('.ae-modal-light')
    ...
    //     .should('be.visible')
    //     .get('.allowance-address > .ae-input-box > .ae-input')
    //     .should('have.value','ak_d45oN2qzS1vqdiWVYCfDeWLVb3EepWxAJrsDbCSmnYiZguerw')
    //     .get('.allowance-value > .ae-input-box > .ae-input')
