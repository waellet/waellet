  ...
  <div class="popup">
    ...
    <div class="addNewName">
      <div class="maindiv_input-group-addon">
        ...
        <hr />
        <ae-input v-model="auctionInfo.info.name" style="margin: 10px 0 10px 0; pointer-events: none;" label="Name" placeholder="..." error> </ae-input>
        ...
        <div style="display:inline-block; margin:20px 0; width:100%;">
          ...
          <ae-text class="righttext" align="right"> {{ auctionInfo.info.winning_bid }} AE </ae-text>
        </div>
        <div>
          <ae-text class="lefttext" align="left">
...
export default {
  ...
  mounted() {
    ...
    this.$watch(({ name }) => this.auctionInfo.info.name, () => this.updateAuctionEntry(), { immediate: true });
    this.loading = false;
  },
  methods: {
