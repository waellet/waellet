<template>
  <div class="popup">
    ...
    <ae-modal v-if="openFilter" @close="openFilter = false" title="Filters" class="filterModal">
      <ae-list class="filters">
        <ae-list-item fill="neutral" class="flex-direction-column">
          ...
          <div>
            ...
            <ae-badge :class="filter.direction == 'incoming' ? 'selected' : ''" @click.native="setFilter('direction', 'incoming')">{{
              $t('pages.transactions.incoming')
            }}</ae-badge>
            <ae-badge :class="filter.direction == 'outgoing' ? 'selected' : ''" @click.native="setFilter('direction', 'outgoing')">{{
              $t('pages.transactions.outgoing')
            }}</ae-badge>
          </div>
        </ae-list-item>
        <ae-list-item fill="neutral" class="flex-direction-column">
          ...
          <div>
            ...
            <ae-badge :class="filter.spendType == 'namePreclaimTx' ? 'selected' : ''" @click.native="setFilter('spendType', 'namePreclaimTx')">{{
              $t('pages.transactions.namePreclaim')
            }}</ae-badge>
            <ae-badge :class="filter.spendType == 'nameClaimTx' ? 'selected' : ''" @click.native="setFilter('spendType', 'nameClaimTx')">{{
              $t('pages.transactions.nameClaim')
            }}</ae-badge>
            <ae-badge :class="filter.spendType == 'nameUpdateTx' ? 'selected' : ''" @click.native="setFilter('spendType', 'nameUpdateTx')">{{
              $t('pages.transactions.nameUpdate')
            }}</ae-badge>
            <ae-badge :class="filter.spendType == 'contractCreateTx' ? 'selected' : ''" @click.native="setFilter('spendType', 'contractCreateTx')">{{
              $t('pages.transactions.createTx')
            }}</ae-badge>
          </div>
        </ae-list-item>
      </ae-list>
      <div class="filterButtons btnFixed">
        <ae-button face="round" @click="clearFilter"><ae-icon name="close" />{{ $t('pages.transactions.clear') }}</ae-button>
        <ae-button face="round" fill="primary" @click="applyFilter"><ae-icon name="check" />{{ $t('pages.transactions.apply') }}</ae-button>
      </div>
    </ae-modal>
  </div>
</template>
